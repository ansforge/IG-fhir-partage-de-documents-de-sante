# Exemple de bundle de type transaction-response du flux 2 - Partage de Documents de Santé en mobilité (PDSm) v3.1.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Exemple de bundle de type transaction-response du flux 2**

## Example Bundle: Exemple de bundle de type transaction-response du flux 2
