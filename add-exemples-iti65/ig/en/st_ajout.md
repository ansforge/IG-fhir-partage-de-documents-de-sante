# Ajout et remplacement de documents (ITI-65) - Partage de Documents de Santé en mobilité (PDSm) v3.1.1

## Ajout et remplacement de documents (ITI-65)
...
* zéro à plusieurs ressources de type « List » représentant les classeurs (profil [PDSm_FolderComprehensive](StructureDefinition-pdsm-folder-comprehensive.md))
...
1. crée la nouvelle`DocumentReference`avec`status = current`et enregistre le lien`relatesTo`,
...
Un exemple complet de bundle de remplacement conforme au profil PDSm est disponible : [bundle-exemple-comprehensiveprovidedocument-replace](Bundle-bundle-exemple-comprehensiveprovidedocument-replace.md).
...
Le corps de la réponse doit être conforme au profil [ProvideDocumentBundleResponse](/IHE.MHD.ProvideDocumentBundleResponse) ([exemple de contenu d'un payload](Bundle-a9c10f8a-882d-4000-a280-7150e0aeb478.json.md)).
