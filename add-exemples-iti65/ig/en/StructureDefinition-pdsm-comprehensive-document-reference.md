...
* Refer to this Profile: [PDSm Folder Comprehensive](StructureDefinition-pdsm-folder-comprehensive.md) and [PDSm SubmissionSet Comprehensive](StructureDefinition-pdsm-submissionset-comprehensive.md)
* Examples for this Profile: [DocumentReference/doc-old](DocumentReference-doc-old.md) and [DocumentReference/exemple-pdsm-documentreference](DocumentReference-exemple-pdsm-documentreference.md)
* CapabilityStatements using this Profile: [CI-SIS Partage-De-Documents-De-Sante - ConsommateurDeDocuments](CapabilityStatement-PDSm-ConsommateurDeDocuments.md), [CI-SIS Partage-De-Documents-De-Sante - GestionnaireDePartageDeDocuments](CapabilityStatement-PDSm-GestionnaireDePartageDeDocuments.md) and [CI-SIS Partage-De-Documents-De-Sante - ProducteurDeDocuments](CapabilityStatement-PDSm-ProducteurDeDocuments.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.pdsm|current/StructureDefinition/StructureDefinition-pdsm-comprehensive-document-reference.json)
...
```json
{
  ...
  "status" : "active",
  "date" : "2026-06-01T14:30:38+00:00",
  "publisher" : "ANS",
  "contact" : [{
    "name" : "ANS",
    "telecom" : [{
