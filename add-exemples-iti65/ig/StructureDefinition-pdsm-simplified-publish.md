...
| Active as of 2026-03-27 | *Computable Name*:PDSm_SimplifiedPublish |
...
* Exemples pour ce/t/te Profil: [DocumentReference/PDSmSimplifiedExample](DocumentReference-PDSmSimplifiedExample.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.pdsm|current/StructureDefinition/pdsm-simplified-publish)
...
```json
{
  ...
  "status" : "active",
  "date" : "2026-03-27T16:32:09+00:00",
  "publisher" : "ANS",
  "contact" : [{
    "name" : "ANS",
    "telecom" : [{
