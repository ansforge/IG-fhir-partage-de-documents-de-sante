...
| [Exemple de DocumentReference existant - cible du remplacement](DocumentReference-doc-old.md) | Fiche de document existante sur le serveur qui sera remplacée. |
