...
Le document dont les caractéristiques principales correspondent aux critères de recherche peut être consulté dans un second temps en utilisant le flux 07 de demande de consultation de document.
...
<div class="figure" style='text-align: center;'>
    <img src="fonctionnel/fig_14.png" alt="Figure 14" title="Figure 14 : Flux 6 - ResultatRechercheDocument" style="width:60%;">
    <figcaption><b>Figure 8 : Processus collaboratif "Recherche de documents"</b></figcaption>
</div>
<br>
