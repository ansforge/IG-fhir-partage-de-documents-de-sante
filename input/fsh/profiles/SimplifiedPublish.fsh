...
// This is a copy of the simplified publish from IHE. When the new version if the IG will be published, this file will be removed to inherit from the official profile
