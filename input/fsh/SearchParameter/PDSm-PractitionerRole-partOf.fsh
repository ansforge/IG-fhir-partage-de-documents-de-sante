...
// Note : ce searchparam n'a pas la même forme que les autres searchparams de PDSm sur le package simplifier (n'a pas List dans le nom) mais a été corrigé par Tristan Riou le 09.01
